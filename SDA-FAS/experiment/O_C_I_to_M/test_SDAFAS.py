...
def main():
    ...
    checkpoint = torch.load("/home/lyc/FACT_DA/experiment/O_C_I_to_M/model_best_transformer_0.05_54.pth.tar", map_location='cpu')
    ...
    # load model
    net_ = torch.load("/home/lyc/FACT_DA/experiment/O_C_I_to_M/model_best_0.05_54.pth.tar")
