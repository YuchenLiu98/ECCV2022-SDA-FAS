...
def get_args_parser():
    ...
    parser.add_argument('--source_model_transformer', default="/home/lyc/experiment/O_C_M_to_I/model_best_transformer.pth.tar",
                        help='path for the pretrained source transformer model')
    parser.add_argument('--source_model_embedder_classifier', default="/home/lyc/experiment/O_C_M_to_I/model_best.pth.tar",
