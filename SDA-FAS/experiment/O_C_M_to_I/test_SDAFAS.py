...
def main():
    ...
    checkpoint = torch.load("/home/lyc/FACT_DA/experiment/O_C_M_to_I/model_best_transformer_0.0225_17.pth.tar", map_location='cpu')
    ...
    # load model
    net_ = torch.load("/home/lyc/FACT_DA/experiment/O_C_M_to_I/model_best_0.0225_17.pth.tar")
