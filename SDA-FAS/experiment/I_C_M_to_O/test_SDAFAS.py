...
def main():
    ...
    checkpoint = torch.load("/home/lyc/FACT_DA/experiment/I_C_M_to_O/model_best_transformer_0.05069_42.pth.tar", map_location='cpu')
    ...
    # load model
    net_ = torch.load("/home/lyc/FACT_DA/experiment/I_C_M_to_O/model_best_0.05069_42.pth.tar")
